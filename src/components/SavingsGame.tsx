      ...
      <>
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-sm uppercase tracking-wider text-primary">Week {week} of 10</p>
            <p className="text-4xl tracking-tight text-primary">${currentSavings} / ${savingsGoal}</p>
          </div>
          <Progress value={progress} className="h-3 bg-slate-700" />
        </div>

        <div>
          <h3 className="text-xl mb-6 tracking-tight text-primary">What's your move this week?</h3>
