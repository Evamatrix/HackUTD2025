...
export default function Landing({ loginWithRedirect }: LandingProps) {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/assets/background.svg')", // Update path
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto mt-8 grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            {/* Box 1 */}
            <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-emerald-200 hover:border-amber-200 transition-all">
              <h2 className="text-4xl font-extrabold text-emerald-800 mb-4">
                Welcome to Financial Fun!
              </h2>
              <p className="text-lg text-teal-700">
                Learn money skills through exciting games. Earn Catnip Points,
                collect badges, and become a financial whiz — all while having
                fun! 🎮
              </p>
            </div>

            {/* Box 2 */}
            <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-teal-200 hover:border-amber-200 transition-all">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="px-8 py-4 rounded-2xl text-white font-semibold shadow-md transition-transform hover:scale-105 bg-gradient-to-r from-amber-400 to-amber-600 hover:from-emerald-600 hover:to-teal-600"
                >
                  Log In
                </button>
          ...
          <div className="space-y-4">
            {/* Box 3 */}
            <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-emerald-200 hover:border-amber-200 transition-all text-center">
              <img
                src="/assets/icons/main-cat.svg"
                alt="Cat mascot"
                className="mx-auto w-32 h-32 mb-4 animate-bounce-slow"
              />
